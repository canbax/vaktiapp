  ...
  describe('can convert seconds to human readable format', () => {
    describe('cases with 1 hour', () => {
      ...
      it.each(formatsWithOnlyHour)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(3600, 'hour', 'minute', 'second', timeFormat);
      ...
      it.each(formatsWithOnlyHourAndMinute)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(3660, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
      ...
      it.each(formatsWithHourMinuteAndSeconds)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(3661, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
      ...
      it.each(formatsWithHourAndSecond)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(3601, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
    });
    ...
    describe('cases with 0 hour', () => {
      ...
      it.each(formatsWithOnlyMinuteAndSecond)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(61, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
      ...
      it.each(formatsWithOnlyMinute)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(60, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
      ...
      it.each(formatsWithOnlySecond)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(1, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
      ...
      it.each(formatsWithAllZero)(
        ...
        ({ timeFormat, expectedResult }) => {
          const oneHour = secondsToHumanReadable(0, 'hour', 'minute', 'second', timeFormat);
          expect(oneHour).toEqual(expectedResult);
        },
      );
    });
  ...
  describe('can convert date to human readable format', () => {
    ...
    it.each(yearFormats)(
      ...
      ({ dateFormat, expectedResult }) => {
        const oneHour = dateToString(new Date(2023, 9, 25), dateFormat, translate);
        expect(oneHour).toEqual(expectedResult);
      },
    );
